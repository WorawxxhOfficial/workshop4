...
class BookRepository {
    ...
    init {
        // เพิ่มข้อมูลตัวอย่าง
        books.add(Book(nextId++, "The Great Gatsby", "F. Scott Fitzgerald"))
        books.add(Book(nextId++, "To Kill a Mockingbird", "Harper Lee"))
        books.add(Book(nextId++, "1984", "George Orwell"))
    }
